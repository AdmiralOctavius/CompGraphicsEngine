...
namespace Geometry
{
	...
	{
		VertexPosTexNormTan vertices[4];

		vertices[0].position = { -.5f,	.5f, 0 };//Top left
		vertices[1].position = { .5f, .5f, 0 };//TR
		vertices[2].position = { .5f, -.5f, 0 };//BR
		vertices[3].position = { -.5f, -.5f, 0 };//BL
